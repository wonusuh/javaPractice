...
public class AccountDAO {
	...
	void deleteAccountsFromList(String id) { // 해당하는 id의 계좌들을 전부 삭제합니다.
	...
	void deleteAnAccount(String delAc) { // 계좌를 검색해서 삭제하고 배열의 크기를 1 줄입니다.
		for (int i = 0; i < accounts.length; i += 1) {
	...
	Account findAnAccountByAccNum(String accNum) { // 계좌번호로 검색해서 해당 계좌를 리턴합니다.
