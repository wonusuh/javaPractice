...
public class ClientDAO {
	...
	protected void showAllClients() { // 고객들의 모든 정보를 출력합니다.
	...
	protected void setAccountsToEachPerson(Account[] accounts) { // 해당 고객의 계좌배열에 계좌를 넣습니다.
	...
	protected Client findAClientById(String id) { // id로 검색해서 객체의 주소를 리턴합니다.
		for (Client c : clients) {
	...
	protected int getIdxById(String id) { // id로 검색해서 인덱스를 리턴합니다.
	...
	protected void deleteAClientFromList(String id) { // 고객 한 명을 삭제하고 배열의 크기를 한 개 줄입니다.
	...
	protected void signUp() { // 배열을 한 개 늘리고 고객 객체를 한 명 추가합니다.
	...
	protected Account findAnAccountByAccNum(String ac) { // 계좌를 검색해서 리턴합니다.
		for (Client c : clients) {
	...
	protected String deleteAnAccount(Client cl) { // 계좌를 검색해서 삭제하고 배열을 한 칸씩 당깁니다.
