...
class NaverButton extends Button {
	@Override
	public void click() {
		System.out.println("같은창에서 네이버로 이동");
	}
...
class GoogleButton extends Button {
	@Override
	public void click() {
		System.out.println("같은창에서 구글로 이동");
	}

	@Override
	public void doubleClick() {
		System.out.println("새창에서 구글로 이동");
	}
